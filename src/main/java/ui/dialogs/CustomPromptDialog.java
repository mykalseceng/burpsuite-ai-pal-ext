...
public class CustomPromptDialog extends JDialog {
    ...
    public CustomPromptDialog(Frame parent, String requestPreview) {
        ...
        promptPanel.add(new JLabel("Enter your prompt:"), BorderLayout.NORTH);
        ...
        previewPanel.add(new JLabel("Request/Response (will be sent with your prompt):"), BorderLayout.NORTH);
